...
import { ExpandLess, ExpandMore, Language, StarBorder } from '@mui/icons-material';
...
export default function Home() {
  ...
  return (
    <Grid2 container size={12}>
      ...
      <br></br>
      <Grid2 size={12} padding={1} bgcolor={'#090f13'} color={'white'} paddingTop={5}>
        <Grid2 size={12} textAlign={'center'}>
          <Typography variant='h4'>Experiências Profissionais</Typography>
        </Grid2>
        <Grid2 container size={12} spacing={2} paddingBottom={10} marginTop={5}>
          {
